...
<div class="mainContainer">
	...
	<div class="sideNav">
		...
		<ul>
			...
			<ul>
			      ...
			      <a href="sanctionManage.jsp"><li>Sanction Management</li></a>
			</ul>
	...
	<div class="content">
	<h2>Conduct Officer Sanction System</h2>
			     

	<p></p>
    <p></p>
    
    	<form action="/GroupProject/NewSServlet" method="post">	
		What are the requirements of the sanction? 
		...
		<br>
				...
				try {
					...
					String QueryString = "SELECT requireID, requireName FROM requirements ORDER BY requireID ASC";
					...
					%>
									...
									<td><input type="checkbox" name="selected" value="<% out.print(rs.getString(1)); %>" /></td>								
									</tr>
					<% }
		...
		<p></p>
		<a href="COCalendar.jsp">Go Back to View Sanctions</a>
